...
<body>
   ...
   <div id="contentWind">         
        <c:forEach var="found" items="${found}" varStatus="num">        
        <p id="contentGood">
        <figure>
        <a href="?action=card&id=${found.id}"><img width="200" src="images/${found.photo }"></a>
        <figcaption>${found.title} <span id="gPrice">${found.price} руб.</span>
        </figcaption>
        <div id="butAdd"><button onclick="add(${found.id})">&#128722;</button></div>        
        </figure></p>        
        </c:forEach>        
